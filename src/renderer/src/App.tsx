  ...
  return (
    ...
    <AppShell dialogOpen={Boolean(dialog)}>
      ...
      <AppRouter view={view}
        ...
        settings={modelData ? <SettingsView data={modelData} projectId={selectedProject?.id} onCancel={() => setView(settingsReturnView.current)} onSaved={finishSettings} /> : null}
        projects={<ProjectView appName={t("app.name")} project={selectedProject} routes={routes} busy={busy} workspaceTitle={t("research.workspaceTitle")} emptyTitle={t("project.emptyTitle")} emptyBody={t("project.emptyBody")} createLabel={t("project.create")} sourceImportUnavailable={t("research.sourceImportUnavailable")} importSources={t("research.importSources")} chatUnavailable={t("research.researchChatUnavailable")} sourcesLabel={t("research.sources")} noSourcesTitle={t("research.noSourcesTitle")} noSourcesBody={t("research.noSourcesBody")} askLabel={t("research.ask")} openSettingsLabel={t("common.openSettings")} sourceActionLabels={{ remove: t("research.removeSource"), selected: t("research.selected"), file: t("research.chooseFiles"), url: t("research.importUrl"), webAddress: t("research.webAddress"), formats: t("research.formats"), importing: t("research.importing"), error: t("research.importError"), indexed: t("research.indexed"), pending: t("research.pending"), importCancel: t("common.cancel"), errorMessages: { "errors.network": t("errors.network"), "errors.timeout": t("errors.timeout"), "errors.provider": t("errors.provider"), "errors.unsupportedFormat": t("errors.unsupportedFormat"), "errors.unsafeInput": t("errors.unsafeInput"), "errors.internal": t("errors.internal") }, cancel: t("research.task.cancel"), retry: t("research.task.retry"), completed: t("research.task.completed"), failed: t("research.task.failed"), queued: t("research.task.queued"), running: t("research.task.running"), cancelled: t("research.task.cancelled"), validating: t("research.task.validating"), staging: t("research.task.staging"), parsing: t("research.task.parsing"), chunking: t("research.task.chunking"), embedding: t("research.task.embedding"), indexing: t("research.task.indexing"), verifying: t("research.task.verifying"), cleanup: t("research.task.cleanup"), finalizing: t("research.task.finalizing"), preparing: t("research.task.preparing"), generating: t("research.task.generating"), saving: t("research.task.saving") }} onOpenSettings={() => void openSettings()} onCreate={openCreateDialog} />}
      />
    </AppShell>
