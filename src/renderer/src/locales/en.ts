const en = {
  ...
  transformations: {
    ...
    practiceHint: "Run a Q&A transformation to generate a practice set.",
    questionSets: "Practice sets",
    questionSet: "Set",
    ...
    known: "Understood",
    review: "Needs review",
    practiceProgress: "Reviewed {{count}} / {{total}} questions",
    unreadableQuestions: "No complete questions could be read. View the insight details or run Q&A again.",
