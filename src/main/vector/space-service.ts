...
export class SpaceService {
  ...
  async rebuild(input:unknown):Promise<void> { if (!this.ops) throw new Error("rebuild is not configured"); await this.ops.rebuild(input); }
